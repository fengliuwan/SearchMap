...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i = 0; i < numVertices; i++) {
			int inN = getInNeighbors(i).size();
			int outN = getNeighbors(i).size();
			ds.add(inN + outN);
		}
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/newbury_small.map", "data/intersections/newbury_small.intersections");
		...
		System.out.println("****");
		System.out.println("newbury_small / intersections:");
		GraphAdjList graphFromFile1 = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/newbury_small.map", graphFromFile1);
		System.out.println(graphFromFile1);
		...
		System.out.println("****");
		System.out.println("hollywood_small / intersections:");
		GraphAdjList graphFromFile2 = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/hollywood_small.map", graphFromFile2);
		...
		System.out.println("****");
		System.out.println("hollywood_large / intersections:");
		GraphAdjList graphFromFile3 = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/hollywood_large.map", graphFromFile3);
		System.out.println(graphFromFile3);
